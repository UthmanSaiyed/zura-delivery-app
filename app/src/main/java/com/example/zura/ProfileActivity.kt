...
/**
 * This class displays  managing user profile information.
 *
 ...
 * Changes are persisted to both Firebase Authentication and Firestore.
 */
class ProfileActivity : AppCompatActivity() {
     ...
     * Sets up the UI components and loads current user data.
     */
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set more descriptive hint for name field
    ...
    private fun showSaveConfirmation(newName: String, newPassword: String) {
        AlertDialog.Builder(this)
            ...
            .setNegativeButton("Yes") { _, _ ->
                updateAccountDetails(newName, newPassword)
            }
            .setPositiveButton("No", null)
            .show()
    }
    ...
    /**
     * Deletes the user's account from both Firebase Authentication and Firestore.
     *
     * This method:
     * 1. Deletes user data from Firestore
     * 2. Deletes the authentication account
     * 3. Navigates to login screen on success
     * 4. Shows appropriate error messages if any step fails
     */
